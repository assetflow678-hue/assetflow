...
export default function AssetDetailPage() {
  ...
  const onStatusUpdate = (values: z.infer<typeof statusUpdateSchema>) => {
    ...
    toast({ title: 'Thành công', description: 'Cập nhật tình trạng tài sản thành công.' });
  };
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
                <h3 className="font-medium">Lịch sử tình trạng</h3>
                        ...
                        <DialogContent>
                            ...
                            <Form {...statusUpdateForm}>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Tình trạng mới</FormLabel>
                                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                <FormControl><SelectTrigger><SelectValue /></SelectTrigger></FormControl>
                                                <SelectContent>
                                                    <SelectItem value="in-use">Đang sử dụng</SelectItem>
                                                    <SelectItem value="broken">Bị hỏng</SelectItem>
                                                    <SelectItem value="repairing">Đang sửa</SelectItem>
                                                    <SelectItem value="disposed">Đã loại bỏ</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </FormItem>
                                    )} />
                        ...
                        <DialogContent>
                            ...
                            <Form {...roomMoveForm}>
                                <form onSubmit={roomMoveForm.handleSubmit(onRoomMove)} className="space-y-4">
                                    ...
                                    <DialogFooter><Button type="submit">Xác nhận chuyển</Button></DialogFooter>
                                </form>
                            </Form>
                        </DialogContent>
                    </Dialog>
                            ...
                            <div className="space-y-4">
                                ...
                                {aiSuggestion && (
                                    <div className="rounded-md border bg-accent/50 p-3 text-sm">
                                        <p className="font-medium">Gợi ý từ AI: <span className="font-bold">{aiSuggestion}</span></p>
                                    </div>
                                )}
                            </div>
                            <DialogFooter>
